...
async function getAccessToken() {
  ...
  if (!MS365_CLIENT_ID || !MS365_CLIENT_SECRET || !MS365_REFRESH_TOKEN) {
    throw new Error('MS365 OAuth credentials not configured (MS365_CLIENT_ID, MS365_CLIENT_SECRET, MS365_REFRESH_TOKEN)');
  }
